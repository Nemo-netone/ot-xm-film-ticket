  ...
  <div class="home-layout">
    <div class="home-films">
      ...
      <div style="margin-top: 20px">
        <el-row :gutter="15">
          <el-col :xs="12" :sm="8" :md="6" v-for="item in data.recommended" style="margin-bottom: 20px; cursor: pointer" @click="navTo('/front/filmDetail?id=' + item.id)">
...
<!--            <div style="margin-top: 5px; font-size: 18px" class="line1">{{ item.title }}</div>-->
      ...
      <div style="margin-top: 20px">
        <el-row :gutter="15">
          <el-col :xs="12" :sm="8" :md="6" v-for="item in data.playingData" style="margin-bottom: 20px">
      ...
      <div style="margin-top: 20px">
        <el-row :gutter="15">
          <el-col :xs="12" :sm="8" :md="6" v-for="item in data.noPlayData" style="margin-bottom: 20px; cursor: pointer" @click="navTo('/front/filmDetail?id=' + item.id)">
            <img :src="item.img" alt="" style="width: 100%; height: 260px; border-top-left-radius: 5px; border-top-right-radius: 5px">
            <div style="margin-top: 5px; font-size: 18px" class="line1">{{ item.title }}</div>
